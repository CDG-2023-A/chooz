...
import com.cdg.chooz.controller.vote.data.VoteListData;
...
import com.cdg.chooz.domain.vote.VoteService;
...
public class VoteController {
    ...
    @PostMapping("")
    public ResponseEntity<CreateVoteResponse> createVote(@Valid @RequestBody CreateVoteRequest createVoteRequest, UserId userId) {
        Long voteId = voteService.createVote(createVoteRequest.toDomain(), userId.getId());
    ...
    @GetMapping("/search")
    public ResponseEntity<GetVoteListResponse> getVoteSearchList(@RequestParam String keyword, @RequestParam SortBy sortBy, @RequestParam int page, @RequestParam int size, @RequestParam(required = false) VoteCategoryType category) {
    ...
    public ResponseEntity<CommonResponse> updateVote(@PathVariable("voteId") Long voteId, @Valid @RequestBody UpdateVoteRequest updateVoteRequest, UserId userId) {
        voteService.updateVote(updateVoteRequest.toDomain(), userId.getId(), voteId);
